#!/usr/bin/env node
/**
 * Write the committed goldens of the agent package's public RUNTIME (value) surface — the
 * name/kind sets that `spec/agentBarrelValueSurface.spec.ts` and
 * `spec/agentDeepSubpathValueSurface.spec.ts` compare against. The probes themselves live in
 ...
 *   pnpm --filter @gaunt-sloth/agent run value-surface:generate
 *
